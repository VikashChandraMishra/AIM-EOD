...
import logo from "../../images/aimlogo.jpg"
                    ...
                    <div className="flex flex-col md:flex-row justify-between w-full">
                        <div>
                            <Link to="/" className="flex flex-col items-center py-4">
                                <img src={logo} alt="unavailable" className="w-24 h-12 md:w-24 md:h-14" />
                            </Link>
                        </div>
 
                        <h3 className="text-base text-center md:text-4xl font-bold md:text-center my-1 md:mt-6">ASSAM INSTITUTE OF MANAGEMENT</h3>
